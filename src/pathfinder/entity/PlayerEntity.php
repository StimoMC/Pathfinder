...
class PlayerEntity extends Human {
    protected Navigator $navigator;

    public function __construct(Location $location, Player $player, ?CompoundTag $nbt = null){
        $this->navigator = new Navigator($this, null, null,
            (new AlgorithmSettings())
                ->setTimeout(0.05)
                ->setMaxTicks(0)
        );
        parent::__construct($location, $player->getSkin(), $nbt);
